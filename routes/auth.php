...
Route::group(['middleware' => ['admin', 'auth']], function () {
  ...
  Route::get("companies", [CompanyController::class, "index"])->name('company.view');
  Route::post("companies", [CompanyController::class, "store"])->name('company.store');
  Route::post("companies/{id}", [CompanyController::class, "update"])->name('company.update');
  Route::get("get-company/{id}", [CompanyController::class, "show"])->name('company.show');
  Route::get("delete-company/{id}", [CompanyController::class, "destroy"])->name('company.delete');

  Route::get("employees/{company_id}", [EmployeeController::class, "index"])->name('employee.view');
  Route::post("employees", [EmployeeController::class, "store"])->name('employee.store');
  Route::get("get-employee/{id}", [EmployeeController::class, "show"])->name('employee.show');
